        ...
        <div className="w-full">
          <div className="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col justify-center">
              <div className="space-y-12 px-[38px] mx-[104px]">
                <div className="space-y-8">
                  <div className="space-y-4">
                    <div className="text-sm uppercase tracking-[0.3em] text-neutral-400 font-light">Visual Artist</div>
                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-light leading-[0.9] text-black tracking-tight">
                      Rediet
                      <br />
                      Haddis
                      <br />
                  ...
                  <p className="text-xl md:text-2xl font-light text-neutral-600 leading-relaxed max-w-lg">
                ...
                <div className="flex items-center space-x-8">
                  <Link
                    href="/contact"
                    className="group flex items-center space-x-3 text-black hover:text-neutral-600 transition-colors duration-300"
                  >
                  ...
                  <a
                    ...
                    className="group flex items-center space-x-2 text-neutral-500 hover:text-black transition-colors duration-300"
                  ></a>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-6 flex justify-center">
              <div className="relative">
                <div className="aspect-[2728/2743] w-full max-w-2xl rounded-sm overflow-hidden bg-neutral-100">
                  <img
                    src="/placeholder.svg?height=2743&width=2728&text=Rediet+Haddis+Portrait"
                    alt="Rediet Haddis"
                ...
                {/* Floating accent */}
                <div className="absolute -top-8 -right-8 w-32 h-32 border border-neutral-200 -z-10"></div>
              </div>
            </div>
          </div>
        </div>
