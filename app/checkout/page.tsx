            ...
            <div>
              ...
              <div className="grid lg:grid-cols-2 gap-16">
                <div className="space-y-8">
                  ...
                  <div className="space-y-6">
                    <h2 className="text-2xl font-medium text-black">Payment Methods (For Reference)</h2>
                    <p className="text-sm text-neutral-600 mb-4">
                      After receiving your quote, you can pay using any of these methods:
                    </p>
                  ...
                  <div className="p-6 rounded-lg border border-red-300 bg-red-50">
                    ...
                    <p className="text-sm text-red-700">
                      Please ensure you send a screenshot of your transfer receipt to complete your order. Orders
                      without payment confirmation will not be processed. For any questions or issues, contact us
                      immediately using the information provided above.
                    </p>
                  </div>
                </div>
