...
const archiveProjects: Project[] = [
  ...
  },
  {
    ...
    photoCount: 7,
    images: Array.from({ length: 7 }, (_, i) => `/placeholder.svg?height=800&width=600&text=In+Red+${i + 1}`),
  },
  {
    ...
    photoCount: 4,
    images: Array.from({ length: 4 }, (_, i) => `/placeholder.svg?height=800&width=600&text=Portal+U-thiopia+${i + 1}`),
  },
  {
    ...
    photoCount: 3,
    images: Array.from({ length: 3 }, (_, i) => `/placeholder.svg?height=800&width=600&text=Decoding+Doc+${i + 1}`),
  },
  {
    ...
    images: Array.from({ length: 19 }, (_, i) => `/placeholder.svg?height=800&width=600&text=To+Identify+${i + 1}`),
  },
  {
    ...
    photoCount: 4,
    images: Array.from({ length: 4 }, (_, i) => `/placeholder.svg?height=800&width=600&text=Tibeb+${i + 1}`),
  },
  {
    ...
    images: Array.from({ length: 18 }, (_, i) => `/placeholder.svg?height=800&width=600&text=Vibrant+Hues+${i + 1}`),
  },
  {
  ...
  },
  {
    ...
    description: "Collection of digital illustrations and ongoing creative work documented on Instagram.",
    detailedDescription:
      "This collection showcases ongoing illustration work that explores Ethiopian cultural themes through digital art. The illustrations combine traditional motifs with contemporary digital techniques, creating a bridge between ancestral artistic traditions and modern creative expression. Follow the ongoing work on Instagram @red_studyo for the latest illustrations and creative process documentation.",
    ...
    images: Array.from({ length: 8 }, (_, i) => `/placeholder.svg?height=800&width=600&text=Illustration+${i + 1}`),
  },
]
