      ...
      <div className="w-full px-12 lg:px-20 py-8">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div
              className="bg-neutral-100 rounded-sm overflow-hidden"
              style={{ width: "711px", height: "895px", maxHeight: "80vh" }}
            >
              <Image
          ...
          <div className="space-y-8">
            {/* Product Info */}
            <div>
              <h1 className="text-4xl font-light leading-tight mb-2 text-black">{item.title}</h1>

              <p className="font-medium text-black text-2xl mb-4">{item.price}</p>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-black mb-3">Panel (1-20)</label>
                  <Select
                    value={selectedPanel.toString()}
                    onValueChange={(value) => setSelectedPanel(Number.parseInt(value))}
                  >
                    <SelectTrigger className="w-full h-12 bg-white border-neutral-300 text-black">
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  <label className="block text-sm font-medium text-black mb-3">Quantity (10 available)</label>
                  <div className="flex items-center gap-3">
                    <button
                      onClick={handleQuantityDecrease}
                      disabled={quantity <= 1}
                      className="w-12 h-12 rounded border border-neutral-300 text-black hover:bg-neutral-100 flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed"
                    >
              ...
              <Button
                ...
                className="w-full h-14 text-base rounded-full bg-black text-white hover:bg-neutral-800 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Add to Cart
              </Button>
            </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mt-16">
          ...
          <div className="p-8 rounded-lg bg-neutral-50">
            <h4 className="text-xl font-medium text-black mb-6">About Interchangeable Panels</h4>
            <div className="space-y-4">
              ...
              <button
                ...
                className="bg-black text-white px-8 py-3 rounded hover:bg-neutral-800 transition-colors self-start flex items-center gap-2 mt-6"
              >
