...
export function InstallationModal({ project, isOpen, onClose }: InstallationModalProps) {
  ...
  // Remove the special case for skins-north-ethiopia from here
            ...
            <div className="w-[30%] p-6 flex flex-col">
              <div className="flex-1 overflow-y-auto">
                <div className="space-y-6">
                  ...
                  {project.id === "skins-east-ethiopia" ? (
                    <>
                      {currentSlide?.description && (
                        <p className="text-neutral-700 leading-relaxed font-medium bg-amber-50 p-4 rounded-lg border-l-4 border-amber-400">
                          {currentSlide.description}
                        </p>
                      )}
                  ...
                  {project.materials && project.materials.length > 0 && project.id !== "skins-east-ethiopia" && (
                    <div className="space-y-2">
                      <h3 className="text-sm font-medium text-neutral-800">Materials</h3>
                      <div className="flex flex-wrap gap-2">
                        {project.materials.map((material) => (
