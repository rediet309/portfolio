...
import { Calendar, Award, Users, Tag } from 'lucide-react'
        ...
        {sortedYears.map((year, yearIndex) => (
          <div key={year} className="mb-20">
            ...
            <div className="flex items-center mb-12">
              <div className={`text-6xl font-stardom ${isDark ? "text-white" : "text-black"} mr-8`}>
                {year}
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projectsByYear[year].map((project, projectIndex) => (
                ...
                >
                  <div className={`rounded-lg overflow-hidden ${isDark ? "bg-neutral-800" : "bg-white"} shadow-lg hover:shadow-xl transition-shadow duration-300`}>
                    {/* Project Image */}
                    ...
                    {/* Project Info */}
                    <div className="p-6">
                      <h3 className={`text-xl font-stardom ${isDark ? "text-white" : "text-black"} mb-2 group-hover:text-opacity-80 transition-colors`}>
                        {project.title}
                      </h3>
                      <p className={`text-sm font-times ${isDark ? "text-neutral-400" : "text-neutral-600"} mb-3`}>
                        {project.medium}
                      </p>
                      <p className={`text-sm font-times ${isDark ? "text-neutral-300" : "text-neutral-700"} mb-4 line-clamp-2`}>
                        {project.description}
                      </p>
                      ...
                      <div className="flex items-center justify-between text-xs">
                        <div className="flex items-center space-x-4">
                          <div className={`flex items-center space-x-1 ${isDark ? "text-neutral-400" : "text-neutral-600"}`}>
